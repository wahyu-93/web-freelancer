                ...
                <div class="col-span-4 text-right">
                    <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                        <button class="flex flex-row items-center w-full px-4 py-2 mt-2 text-left bg-white rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:w-auto md:inline md:mt-0 md:ml-4">
                            @if(auth()->user()->detailUser()->first()->photo)
                                <img 
                                    src="{{ Storage::url(auth()->user()->detailUser()->first()->photo) }}" alt=""
                                    class="inline w-12 h-12 mr-3 rounded-full">
                            @else
                                <svg class="w-12 h-12 mr-3 rounded-full inline text-gray-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="p-4 lg:col-span-7 md:col-span-12 md:pt-0">
                    <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{ asset('assets/images-logo/services-progress-icon.svg') }}" alt="" class="w-8 h-8">
                                </div>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{ asset('assets/images-logo/services-completed-icon.svg') }}" alt="" class="w-8 h-8">
                                </div>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{ asset('assets/images-logo/new-freelancer-icon.svg') }}" alt="" class="w-8 h-8">
                                </div>
                                ...
                                <tbody class="bg-white">
                                    <tr class="text-gray-700">
                                            ...
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    @if($order->order_status_id == '1')
                                                       <p class="text-sm text-green-500">{{ $order->orderStatus->name }}</p>
                                                    @elseif($order->order_status_id == '2')
                                                        <p class="text-sm text-yellow-400">{{ $order->orderStatus->name }}</p>
                                                    @elseif($order->order_status_id == '3')
                                                        <p class="text-sm text-red-500">{{ $order->orderStatus->name }}</p>
                                                    @else
                                                        <p class="text-sm text-gray-400">{{ $order->orderStatus->name }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        <td class="w-2/4 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    ...
                                                    @if(count($order->service->thumbnails))
                                        ...
                                        <td class="px-1 py-5 text-xs text-red-500">
                                            ...
                                            {{ date("d F Y", strtotime($order->expired)) }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        @empty
                            <h1 class="text-center text-2xl mt-4">"oppps. You don't have orders"</h1>
                        @endforelse
                ...
                <aside class="p-4 lg:col-span-5 md:col-span-12 md:pt-0">
                    <div class="relative w-full h-56 m-auto text-white transition-transform transform bg-red-100 rounded-xl">
                        ...
                        <img class="relative object-cover w-full h-full rounded-xl" src="{{ asset('assets/images-logo/card-background.png') }}" alt="">
                        ...
                        <div class="absolute w-full px-8 top-8">
                            <div class="flex justify-between">
                                ...
                                <img class="w-16 h-12" src="{{ asset('assets/images-logo/visa-icon.svg') }}" alt="" />
                            </div>
                            <div class="pt-6">
