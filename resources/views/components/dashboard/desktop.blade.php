...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white md:block" aria-label="aside">
    <div class="text-serv-bg">
        <div class="" href="#">
            <img src="{{ asset('assets/images-logo/logo.svg') }}" alt="" class="object-center mx-auto my-8 ">
        </div>
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            @else
                <img class="object-cover object-center mr-1 rounded-full w-14 h-14"
                    src="{{ Storage::url(auth()->user()->detailUser->photo) }}" alt="random user" />
            @endif
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('member.request.index') }}">
                    ...
                    <span class="inline-flex items-center justify-center px-3 py-2 ml-auto text-xs font-bold leading-none text-green-500 rounded-full bg-serv-green-badge">
                        {{ auth()->user()->orderFreelancers->count() }}
                    </span>
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('member.profile.edit', 1) }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
